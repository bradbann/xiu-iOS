...
#define WeiXinAppID @"wx6732d4e4f246c1b6"
#define WeiXinAppSecret @"8b31e6d207ac1585f6e0a1bd11ef2367"

#define QQAppID @"1105123850"
#define QQAppKey @"imFGqsaBBiNXrhMH"

#define WeiBoAppKey @"29028352"
#define WeiBoAppSecret @"877254d492d6e9e119c624fc5a5cf97b"
#define WeiBoRedirectURI @"http://sns.whalecloud.com"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[SKPaymentQueue defaultQueue] addTransactionObserver:[LSInAppPurchaseHelper sharedHelper]];
    return YES;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.puacg.LetsShow" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"LetsShow" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"LetsShow.sqlite"];
    NSError *error = nil;
